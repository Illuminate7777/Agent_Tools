...
class Agent:
    def __init__(self, model, temperature=0, max_tokens=1000, planning_agent_prompt=None, integration_agent_prompt=None, verbose=False):
    ...
    def check_response(self, response, query):
        ...
        arguments_json = json.loads(['function']['arguments'])
