...
class WebSearcher:
    ...
    def generate_searches(self, plan, query):
        ...
        tool_calls = response_dict['choices'][0]['message']['function_call'][0]
    ...
    def get_search_page(self, search_results, plan, query):
        ...
        function_calls = response_dict['choices'][0]['message']['tool_calls'][0]
        arguments_json = json.loads(function_calls['function']['arguments'])
